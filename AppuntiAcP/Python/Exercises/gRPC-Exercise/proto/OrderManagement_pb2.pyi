...
class CombinedShipment(_message.Message):
    __slots__ = ("id", "status", "ordine")
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ORDINE_FIELD_NUMBER: _ClassVar[int]
    id: str
    status: str
    ordine: _containers.RepeatedCompositeFieldContainer[Order]
    def __init__(self, id: _Optional[str] = ..., status: _Optional[str] = ..., ordine: _Optional[_Iterable[_Union[Order, _Mapping]]] = ...) -> None: ...
